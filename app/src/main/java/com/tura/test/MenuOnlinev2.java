...
public class MenuOnlinev2 extends AppCompatActivity {
    ...
    public void FindGame(View v) throws IOException {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.contentEquals("wait")){
                            messageOnDisplay.setText("Connesso , aspetta un avversario!");
                            handler.postDelayed(() -> {
                                try {
                                    FindGame(v);
                                } catch (IOException e) {
                        ...
                        else if ((!response.contentEquals("wait"))){
                            Intent i = new Intent(MenuOnlinev2.this, Multiplayerv2.class);
...
//                            messageOnDisplay.setText("Errore , probabilmente non hai connessione a Internet!");
    ...
    public void BackToMenu(View v){
        Intent i = new Intent(MenuOnlinev2.this, MenuPrincipale.class);
        finish();  //Kill the activity from which you will go to next activity
        startActivity(i);
    }
